...
function emtr_render_compose_email() {
	if( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] ) &&  $_POST['action'] == "emtr_send_mail") {
	...
	<div class="wrap">
		...
		<form method="post">
			<table  class="form-table">
				<tr> 
					<th scope="row">  
						<label for="to"><?php esc_html_e('From', EMTR_TEXT_DOMAIN);?></label> 
					</th>
					<td> 
						<input type="text" name="from" value="<?php echo esc_attr( get_bloginfo('admin_email') );?>" placeholder="<?php esc_attr_e('From', EMTR_TEXT_DOMAIN);?>" tabindex="1" class="regular-text" required>
					</td>  
				</tr>
                <tr> 
					<th scope="row">  
					...
					<td> 
						<input type="text" name="to" value="" placeholder="<?php esc_attr_e('To', EMTR_TEXT_DOMAIN);?>" tabindex="2" class="regular-text" required>
					</td>  
				</tr>
				<tr> 
					<th scope="row">  
					...
					<td>
						<input type="text" name="subject" value="" placeholder="<?php esc_attr_e('Subject', EMTR_TEXT_DOMAIN);?>" tabindex="3"  class="regular-text"  required>
					</td>
				</tr>     
				<tr> 
					<th scope="row">  
						<label for="attachment"><?php esc_html_e('Attachments', EMTR_TEXT_DOMAIN);?></label> 
					</th>
					<td>
